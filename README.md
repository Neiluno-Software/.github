...
🔸 BackEnd: Go, Rust, Node.js, ExpressJS, Nest.js, Python, Django, Flask, AWS, Digital Ocen, Serverless, RESTFul API, AI

☀️ Mobile App: React Native, Android Java, Flutter

💥 Others: Telegram Miniapp, Linux/Unix, Microsoft Office

★ Blockchain: Solidity (ERC20, 721, 721A, 1155, 404, and Other Smart Contracts), Solana, Cosmwasm, Web3.js, ethers.js, web3-react, wagmi, viem, rainbowkit
